<template>
  ...
  <div class="container pt-3 pb-1">
    <h2 class="text-center text-dark mb-4">Project snapshots</h2>
      ...
      <div class="mx-0 row row-cols-1 row-cols-sm-2 row-cols-md-3">
        <div class="col mb-2" v-for="(k, v) in item" :key="v">
          <div class="card h-100">
            <div class="card-header bg-primary bg-gradient text-white" style="font-weight: 900; font-size: 18px;">
              {{ k.title }}
            </div>
...
<script>
import {samples} from '@/database/projects_en'
export default {
  data() {
    return {
      samples: samples,
